...
export default function RefIncomeHistory() {
  ...
  async function getInvestmentList() {
    api
      .post("getIncomeHistory", { income_type: "referalIncome" })
      .then((res) => {
    ...
    <>
      <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div className="d-block mb-4 mb-md-0">
          <h2 className="h4">Referrral Income History</h2>
        </div>
      </div>
      <div className="table-settings mb-4">
        ...
        <div className="my-2">
          <div className="d-flex justify-content-end">
            <div>Total Referral Income : {totalIncome}</div>
          </div>
          <DataGrid
            //loading={loadingData}
            getRowId={(r) => r._id}
