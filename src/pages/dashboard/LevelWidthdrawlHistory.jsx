...
export default function LevelWidthdrawlHistory() {
  ...
  async function getWidthdrawlHistory() {
    api
      .post("getWithdrawalHistory", { income_type: "pool_wallet" })
      .then((res) => {
        console.log(res.data);
        setTotalWith(res.data.totalInvestments);
      ...
      <div className="table-settings mb-4">
        ...
        <div className="my-2">
          <div className="d-flex justify-content-end">
            <div>Total Level Withdrawl : {totalWith}</div>
          </div>
          <DataGrid
            //loading={loadingData}
            getRowId={(r) => r._id}
